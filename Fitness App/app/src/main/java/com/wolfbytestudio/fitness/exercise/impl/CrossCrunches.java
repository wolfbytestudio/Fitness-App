 ...
 */
public class CrossCrunches extends Exercise
{

    private static final long serialVersionUID = -6060303398244091883L;

    /**
     * The name of the exercise
     */
    private static final String NAME = "Cross Crunches";
     ...
     */
    private static final float CALS = 0.21F;

    /**
     * Pushup constructor
     */
    public CrossCrunches()
    {
