 ...
 */
public class TrianglePushUps extends Exercise
{

    private static final long serialVersionUID = 7164739278582294196L;

    /**
     * The name of the exercise
     */
    private static final String NAME = "Triangle Push Ups";
     ...
     */
    private static final float CALS = 0.1F;

    /**
     * Pushup constructor
     */
    public TrianglePushUps()
    {
