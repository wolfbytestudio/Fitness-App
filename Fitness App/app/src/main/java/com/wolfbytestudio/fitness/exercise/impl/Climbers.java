 ...
 */
public class Climbers extends Exercise
{
     ...
     */
    private static final String NAME = "Mountain Climbers";
    ...
    private static final MuscleGroup[] MUSCLE_GROUP = {
            ...
            MuscleGroup.OBLIQUES, MuscleGroup.QUADRICEPS, MuscleGroup.HAMSTRINGS
    };
     ...
     */
    private static final float CALS = 0.2F;
